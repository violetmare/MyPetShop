...
ON 
( NAME = MyPetShop,
    FILENAME = 'D:\ASPNET\MyPetShop\MyPetShop.Web\App_Data\MyPetShop.mdf',
    SIZE = 5MB,
    MAXSIZE = 50MB,
    FILEGROWTH = 1MB )
LOG ON
( NAME = MyPetShop_log,
    FILENAME = 'D:\ASPNET\MyPetShop\MyPetShop.Web\App_Data\MyPetShop_log.ldf',
    SIZE = 3MB,
    MAXSIZE = 25MB,
    FILEGROWTH = 1MB )
...
GO
USE MyPetShop
/*分别建立Category、Supplier、Product、Customer、Order、OrderItem、CartItem等数据表的结构*/
CREATE TABLE [Category] ([CategoryId] int identity PRIMARY KEY, [Name] nvarchar(80) NULL, [Descn] nvarchar(255) NULL)
CREATE TABLE [Supplier] ([SuppId] int identity PRIMARY KEY,
  [Name] nvarchar(80) NULL, [Addr1] nvarchar(80) NULL, [Addr2] nvarchar(80) NULL,
  [City] nvarchar(80) NULL, [State] nvarchar(80) NULL, [Zip] nvarchar(6) NULL,
...
CREATE TABLE [Product] ([ProductId] int identity PRIMARY KEY,
  ...
  [SuppId] int NULL REFERENCES [Supplier]([SuppId]), [Name] nvarchar(80) NULL,
  [Descn] nvarchar(255) NULL, [Image] nvarchar(80) NULL, [Qty] int NOT NULL)
...
CREATE TABLE [Order] ([OrderId] int identity PRIMARY KEY,
  ...
  [Addr1] nvarchar(80) NULL, [Addr2] nvarchar(80) NULL, [City] nvarchar(80) NULL,
  [State] nvarchar(80) NULL, [Zip] nvarchar(6) NULL, [Phone] nvarchar(40) NULL,
  [Status] nvarchar(10) NULL)
CREATE TABLE [OrderItem]([ItemId] int identity PRIMARY KEY,
  [OrderId] int NOT NULL REFERENCES [Order]([OrderId]), [ProName] nvarchar(80),
  [ListPrice] decimal(10, 2) NULL, [Qty] int NOT NULL, [TotalPrice] decimal(10, 2) NULL)
CREATE TABLE [dbo].[CartItem]([CartItemId] int identity PRIMARY KEY,
	[CustomerId]  int NOT NULL REFERENCES [Customer]([CustomerId]), 
...
/*在Customer表中插入示例数据*/
INSERT [dbo].[Customer] ([Name], [Password], [Email]) VALUES ('admin', '123', 'admin@qq.com')
INSERT [dbo].[Customer] ([Name], [Password], [Email]) VALUES ('jack', '123', 'ssgwcyxxd@126.com')
GO
